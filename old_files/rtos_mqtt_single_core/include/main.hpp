...
constexpr bool ENABLE_TASK_SENSORS      = true;
constexpr bool ENABLE_TASK_IMU          = true;
constexpr bool ENABLE_TASK_RFID         = false;
constexpr bool ENABLE_MQTT              = true;

// Sensor component switches used inside func_sensors().
constexpr bool ENABLE_SENSOR_IR_ARRAY   = true;
constexpr bool ENABLE_SENSOR_ULTRASONIC = true;
constexpr bool ENABLE_SENSOR_SUN_LIGHT  = true;
...
constexpr float TURN_MAX_W                    = 2.0f;
...
extern volatile bool wifi_busy;
...
extern RunningState running_state;
